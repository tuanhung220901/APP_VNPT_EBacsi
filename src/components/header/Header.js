...
<nav className="bg-white border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800">
    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <NavLink to="/" className="flex items-center">
            <img src="https://ebacsi.com.vn/assets/img/logo.png" className="mr-3 h-6 sm:h-14" alt="Flowbite Logo" />
        </NavLink>
            ...
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                <li>
                  <NavLink to="/gioi-thieu" activeClassName="active">
                    <a href="#" className="block py-2 pr-4 pl-3 text-[#005baa] border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 lg:text-[18px] lg:font-semibold">GIỚI THIỆU</a>
                  </NavLink>
                </li>
                <li>
                    <NavLink to="/cac-goi-dich-vu-y-te" className="block py-2 pr-4 pl-3 text-[#005baa] border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 lg:text-[18px] lg:font-semibold">CÁC GÓI DỊCH VỤ Y TẾ</NavLink>
                </li>
                <li>
                    <NavLink to="/tin-tuc" className="block py-2 pr-4 pl-3 text-[#005baa] border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 lg:text-[18px] lg:font-semibold">TIN TỨC</NavLink>
                </li>
                <li>
                    <NavLink to="/dang-ky-nhan-tu-van" className="block py-2 pr-4 pl-3 text-[#005baa] border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 lg:text-[18px] lg:font-semibold">NHẬN ĐĂNG KÝ TƯ VẤN</NavLink>
                </li>
            </ul>
        </div>
    </div>
